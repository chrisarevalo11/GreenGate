...
type ProjectCardProps = {
  seasonMetadata: formValuesTypes;
};
...
export default function ProjectCard({
  ...
  return (
    <div className="card card-compact w-[300px] bg-neutral shadow-xl overflow-hidden h-[230px] flex flex-col items-center lg:sticky lg:top-3">
      <figure
